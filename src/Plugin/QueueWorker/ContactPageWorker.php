...
/**
 * A contact page worker.
 *
 * @QueueWorker(
 *   id = "civicrm_user_contact_page_queue",
 *   title = @Translation("Contact page worker"),
 *   cron = {"time" = 1}
 * )
 */
class ContactPageWorker extends QueueWorkerBase implements ContainerFactoryPluginInterface {
   ...
   */
  protected function processContactPage($worker, $item) {
    // @todo implement
  ...
  public function processItem($data) {
    $this->processContactPage(1, $data);
  }
